    ...
    <div>
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          <div className="mt-5 max-w-2xl text-center mx-auto">
            {/* <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              AI Content
              <span className="bg-clip-text bg-gradient-to-tl from-purple-600 to-blue-900 text-transparent">
                {" "}
                Generator
              </span> */}
              <h1 className="bg-clip-text bg-gradient-to-tl  from-purple-600 to-blue-900 text-transparent block font-bold  text-4xl md:text-5xl lg:text-6xl">
              ContentGen 
              <span className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
                {" "}
                AI
              </span>
            </h1>
      ...
      gap-x-3 text-center bg-gradient-to-tl from-blue-600
       to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:focus:ring-offset-gray-800"
            ...
            >
             ...
             <Link
                href="https://www.linkedin.com/in/khushbu-mandal-5a644b312/"
                target="blank"
                className="inline-flex justify-center items-center 
      gap-x-3 text-center bg-gradient-to-tl from-blue-600
       to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:focus:ring-offset-gray-800 "
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
          <a
            ...
            href="#"
          >
            <div className="flex justify-center items-center size-12 bg-purple-950 rounded-xl">
              <svg
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t dark:border-muted">
        <p className="text-xs text-muted-foreground dark:text-muted-foreground">
          &copy; 2024 ContentGen AI Inc. All rights reserved.
        </p>
