...
export default  [
    ...
    },
    {
        ...
        aiPrompt: 'Generate 15 Instagram hash tag depends on a given keywords and also differentiate into general , specific and unique format and give output in  in rich text editor format',
        form: [
            {
